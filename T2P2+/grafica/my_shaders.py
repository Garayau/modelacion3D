""" Pipelines con los shaders creados """

from OpenGL.GL import *
import OpenGL.GL.shaders
from grafica.gpu_shape import GPUShape

 # Pipeline para multiples fuentes de luz, sin texturas y sin uniforms para la posiciones de la luces
...
# Pipeline para multiples fuentes de luz, con texturas y sin uniforms para la posiciones de la luces
...
# Pipeline para multiples fuentes de luz, sin texturas y con un arreglo de uniforms
class MultiplePhong2ShaderProgram:
...
# Pipeline para multiples fuentes de luz, sin texturas y con un arreglo de estructuras como uniforms
class MultiplePhong3ShaderProgram:
    # Pipeline para multiples fuentes de luz, sin texturas
